...
//                                FindItemAddOn.getConfigProvider().PLUGIN_PREFIX + FindItemAddOn.getConfigProvider().FIND_ITEM_CMD_INCORRECT_USAGE_MSG));
//                    }
...
//                            player.sendMessage(ColorTranslator.translateColorCodes(
//                                    FindItemAddOn.getConfigProvider().PLUGIN_PREFIX
//                                            + "&CIncorrect usage! Try &e/finditem &freload"));
//                        }
//                    }
//                    else {
...
//                        player.sendMessage(ColorTranslator.translateColorCodes(
//                                FindItemAddOn.getConfigProvider().PLUGIN_PREFIX + FindItemAddOn.getConfigProvider().FIND_ITEM_CMD_NO_PERMISSION_MSG));
//                    }
//                }
//            }
//        }
