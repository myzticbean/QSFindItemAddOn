...
public class LocationUtils {
    ...
    private static List<Material> damagingBlocks;
    private static List<Material> nonSuffocatingBlocks;
    ...
    public static void initDamagingBlocksList() {
        damagingBlocks = new ArrayList<>();
